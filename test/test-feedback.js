    ...
    it('should return feedback with the right fields', function(){
      ...
      return EventModel
        ...
        .then(function(res){
          ...
          const expectedKeys = ["content", "optIn", "name", 'email', 'phone', 'updates', 'feedback', 'volunteer', 'didAnything', '_id', 'timeStamp', 'eventId']
        ...
        .then(function(feedback){
          const matchKeys = ["content", "optIn", "name", 'email', 'phone', 'updates', 'feedback', 'volunteer', 'didAnything', 'timeStamp', 'eventId']
    ...
    it("should add new feedback", function() {
      return EventModel
        ...
        .then(function(res) {
          ...
          expect(res.body).to.include.keys("content", "optIn", "name", 'email', 'phone', 'updates', 'feedback', 'volunteer', 'didAnything', '_id', 'timeStamp', 'eventId');
